...
while [ "$#" -gt "0"  ] ; do
  case "$1" in
    ...
    -ex|--examples)
    echo "examples:
bash HOG.sh -c CountryName -p 80 -o /tmp/Country80
bash HOG.sh -c CountryName -pp 80,3389  -o  /tmp/Country80-3389
...
bash HOG.sh -e mikrotik -c CountryName  -o /tmp/Countrymikexp
...
bash HOG.sh -e fortigate -c CountryName -o /tmp/Countryfortigateexp
...
bash HOG.sh -e juniper -c CountryName -o /tmp/Countryjuniperexp
...
bash HOG.sh -c CountryName -router -o /tmp/Countryrouters/ 
bash HOG.sh -c CountryName -range -o /tmp/Countryrange 
